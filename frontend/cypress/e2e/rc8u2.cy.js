describe('R8UC1: Adding a todo to an added task', () => {
    ...
    it('Click on the Icon in front of "active" todo item to set to "done". Toggled item is struck through.', () => {
        cy.get('li.todo-item span.checker.unchecked')
            .first()
            .click()
    ...
    it('Click on the Icon in front of "done" todo item to set to "Active". Toggled item is not striked through.', () => {
        cy.get('li.todo-item span.checker.checked')
            .first()
            .click();
        cy.get('li.todo-item span.checker.unchecked')
